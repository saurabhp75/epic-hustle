export default function TermsOfServiceRoute() {
	return (
		<div>
			...
			<h3>Introduction</h3>
			<p>
				Welcome to Sorablue, operated by Saurabh Prakash and our team ("Company",
				...
				your use of our web pages located at https://sorablue.app/ operated by
				Sorablue. Our Privacy Policy also governs your use of our Service and
				...
				https://Sorablue.app/privacy. Your agreement with us includes these
				...
				support@sorablue.app so we can try to find a solution. These Terms apply
			...
			<p>
				...
				the exact same conditions unless you cancel it or Sorablue cancels it.
				You may cancel your Subscription renewal either through your online
				account management page or by contacting Sorablue customer support team.
				A valid payment method, including credit card or PayPal, is required to
				process the payment for your subscription. You shall provide Sorablue
				...
				authorize Sorablue to charge all Subscription fees incurred through your
				account to any such payment instruments. Should automatic billing fail
				to occur for any reason, Sorablue will issue an electronic invoice
			...
			<h3>Free Trial</h3>
			<p>
				Sorablue may, at its sole discretion, offer a Subscription with a free
				...
				you will not be charged by Sorablue until Free Trial has expired. On the
				...
				notice, Sorablue reserves the right to (i) modify Terms of Service of
				Free Trial offer, or (ii) cancel such Free Trial offer.
			</p>
			<h3>Fee Changes</h3>
			<p>
				Sorablue, in its sole discretion and at any time, may modify Subscription
				...
				without notice, Sorablue reserves the right to (i) modify Terms of
			...
			<p>
				Sorablue is committed to providing high-quality, reliable service for all
			...
			<p>
				...
				Sorablue and its licensors. Service is protected by copyright, trademark,
				...
				product or service without the prior written consent of Sorablue.
			</p>
			...
			<p>
				...
				via email to support@sorablue.app, with the subject line: “Copyright
			...
			<p>
				...
				contact our team via email at support@sorablue.app Error Reporting and
				Feedback You may provide us either directly at support@sorablue.app or
			...
			<p>
				...
				are not owned or controlled by Sorablue Sorablue has no control over, and
				...
				You acknowledge and agree that Sorablue shall not be responsible or
			...
			<p>
				...
				Contact Us You can contact us by emailing to: support@sorablue.app for
				any queries.
			</p>
		</div>
	)
