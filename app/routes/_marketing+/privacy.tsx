export default function PrivacyRoute() {
	return (
		<div>
			...
			<h3>Introduction </h3>
			<p>
				sorablue, operated by Saurabh Prakash and our team (“Company”, “us”,
				“we”, or “our”) operates https://sorablue.app/ (hereinafter referred to
				as “Service”). Our Privacy Policy governs your visit to
				https://sorablue.app/, and explains how we collect, safeguard, and
			...
			<h3>Definitions</h3>
			<p>
				Service means the https://sorablue.app/ website operated by sorablue.
			...
			<p>
				...
				or by emailing at support@sorablue.app.
			</p>
			<h3>Personal Data</h3>
			<p>
			...
			<h3>Use of Data</h3>
			<p>sorablue uses the collected data for various purposes:</p>
			<h3>Personal Data</h3>
			<p>
			...
			<p>
				...
				agreement to that transfer. sorablue will take all the steps reasonably
			...
			<p>
				...
				please email us at support@sorablue.app. In certain circumstances, you
			...
			<p>
				...
				by emailing us at support@sorablue.app.{' '}
			</p>
			...
			<p>
				sorablue may use remarketing services to advertise on third party
